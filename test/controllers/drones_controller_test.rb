...
class DronesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create drone" do
    assert_difference('Drone.count') do
      post drones_url, params: { drone: { acquired_date: @drone.acquired_date, carrying_capacity: @drone.carrying_capacity, name: @drone.name, price: @drone.price, status: @drone.status, weight: @drone.weight } }
    end
  ...
  test "should update drone" do
    patch drone_url(@drone), params: { drone: { acquired_date: @drone.acquired_date, carrying_capacity: @drone.carrying_capacity, name: @drone.name, price: @drone.price, status: @drone.status, weight: @drone.weight } }
